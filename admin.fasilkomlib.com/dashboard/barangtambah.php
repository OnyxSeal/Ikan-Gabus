...
if (isset($_POST["submit"])) {
  ...
  echo "<script>alert('PDF file does not exist');</script>";
  } else {
    ...
    if ($pdfExt !== 'pdf') {
      ...
      $cleanTitle = preg_replace('/[^\w\-]/', '', $cleanTitle);
      $pdfNewName = $cleanTitle . '_' . date("Y-m-d_H.i.s") . '.' . $pdfExt;
  ...
  <div class="nasiLemak">
    <div class="nasiPadang">
      ...
      <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
        ...
        <label for="pdf">PDF Buku : </label>
        <input class="input" type="file" name="pdf" id="pdf" accept=".pdf" required> <br>
